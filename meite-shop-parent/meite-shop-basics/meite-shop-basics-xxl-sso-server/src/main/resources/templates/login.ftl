...
<body>
	...
	<div class="layui-fulid" id="house-login">
		<form action="${request.contextPath}/doLogin" method="post">
			<div class="layui-form">
				...
				<span style="color: red; font-size: 20px; font-weight: bold; font-family: '楷体', '楷体_GB2312';">${errorMsg!''}</span>
	...
	<script src="${request.contextPath}/static/res/layui/layui.js"></script>
	<!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
	<!--[if lt IE 9]>
...
<![endif]-->
	<script>
		layui.config({
			base : '${request.contextPath}/static/res/static/js/'
		}).use('house');
	</script>
